...
if (kvittering) {
    ...
    // Vi kunne gemme data til en JSON-fil, men den kan tilgås af alle 
    // når hjemmesiden kommer til at ligge ude på nettet.
...
function vindueTekst(boxvalg) {
    ...
    switch (boxvalg) {  // Switch-case der tjekker hvilken tekst der er sendt i funktion parametret
        ...
        case 'hosmig':
            overskrift = "HOS MIG"
            tekst = "Her besøger du mit samtalerum, som er beliggende på egen adresse. Her forsikrer jeg dig om det mest hyggelige terapirum, hvor der er masser af hjerterum, åbenhed og plads, trods størrelsen af det, til at det kan rumme alle dine følelser og fortællinger."
            break; // Break, gør at man hopper ud af switch, når en tilsvarende "case" er fundet
        case 'walkandtalk':
            overskrift = "WALK AND TALK"
            tekst = "Jeg tilbyder walk & talk. Her kan vi bl.a. gå en tur i naturen langs Holbæk fjord, eller gå en tur i skoven. Her lytter jeg til dig og din historie samtidig med, at jeg stiller dig spørgsmål. Naturens smukke åbne plads kan have sin indflydelse på dig, når du søger efter balance og frihed. Her kan du komme mere i kontakt med dig selv og dine kreative tanker, da der er højt til loftet i naturen. Du vil under walk & talk opleve, at du, når du er i bevægelse, slipper og løsner den fastspændthed, du følelsesmæssigt er i."
            break;
        case 'online':
            overskrift = "ONLINE"
            tekst = "En fleksibilitet hos mig er online samtaler. Det fungerer perfekt til dig, der ikke kan få logistikken til at hænge sammen, eller for dig, der har brug for at spare tid i en travl hverdag. Derfor er alle velkomne hos mig, og jeg får det til at fungere, lige meget om du bor i Holbæk eller omegn, eller om du bor længere væk. Opstår der sygdom, så fungerer onlinesamtaler, hvis du stadig, trods sygdom, har brug for at snakke med mig. Jeg er vant til onlineterapi og coaching, så hos mig er du i trygge hænder. Der er et sikkert onlinerum til rådighed, hvor vi kan mødes via et link, jeg sender til dig. Alt skal være komfortabelt for dig, og det sikrer jeg, at det er."
            break;
        case 'ambition':
            overskrift = "MIN AMBITION"
            tekst = "Min ambition er at hjælpe jer kvinder med at erobre sig selv tilbage og det liv, i drømmer. I skal hos mig opnå at kunne forkæle jer selv, og lærer at sætte jer selv først, uden at i tilsidesætter andre nær jer. I skal hos mig kunne opnå friheden til at være jer selv, og samtidig opleve at være i balance med jeres egne grænser og andres behov og forventninger til jer."
            break;
        case 'styrker':
            overskrift = "MINE STYRKER"
            tekst = "Jeg kan med min erfaring og viljestyrke komme helt derind, hvor sandheden findes. Der hvor dine drømme og udtalte ønsker og behov ligger. Jeg ved hvor nøglerne er til de døre, du har brug for at låse op, ligger. Sammen kan vi lirke dem op, helt stille og roligt i dit eget tempo. Jeg vil være ved din side hele vejen. Både nysgerrig, kærlig, ærlig og støttende. Udover det, vil jeg også puffe til dig, for det trænger du til. Dog er det kærlige puf, der får dig videre i den rigtige retning."
            break;
        case 'motivation':
            overskrift = "MIN MOTIVATION"
            tekst = "Min motivation ligger i, at jeg selv ved, hvor befriende, skønt og lækkert det er at finde vejen hjem til sig selv igen. Jeg har selv taget vejene hjem. Den vil jeg gerne vise dig. Grundet min egen erfaring, står jeg stærkere i livet, end jeg nogensinde har gjort før. Jeg ønsker at flere kvinder, som dig, skal stå stærk i dem selv, så de kan leve det liv, de drømmer om."
            break;
        default:
            break;
    }
